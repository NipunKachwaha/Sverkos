export const NAVIGATION_DATA = {
    ...
    products: {
        leftMenu: {
            title: "AI Models",
            items: [
                { title: "Build AI", desc: "Develop and generate production-ready code.", link: "/build" },
                { title: "Plan AI", desc: "Architect and strategize your projects.", link: "/plan" },
                { title: "Discuss AI", desc: "Collaborate and refine ideas with agents.", link: "/ai/discuss" },
                { title: "Deploy AI", desc: "Ship and host your solutions to the cloud.", link: "/ai/deploy" },
                { title: "Agents AI", desc: "Automate complex tasks with autonomous agents.", link: "/ai/agents" },
            ]
        },
        rightMenu: {
            title: "Mod Categories",
            items: [
                { title: "UI Themes", desc: "Customize your interface.", link: "/mods/themes" },
                { title: "Automations", desc: "Automate repetitive tasks.", link: "/mods/automations" },
                { title: "Integrations", desc: "Connect third-party tools.", link: "/mods/integrations" },
                { title: "Performance", desc: "Optimize speed & memory.", link: "/mods/performance" },
            ]
        }
    }
};