...
export const ClockIcon = ({ className }: Props) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const MovieIcon = ({ className }: Props) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
...
export const WeeklyProjectIcon = ({ className }: Props) => (
  <img
    src="/icons/weeklyproject.png"
    alt="Project Icon"
    id="project"
    className={className}
    width={24}
